...
st.markdown('<p class="sub-header">Generate production-ready API integration code in minutes, powered by Claude 4.6 Sonnet</p>', unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.caption("**Powered by Claude 4.6 Sonnet**")
